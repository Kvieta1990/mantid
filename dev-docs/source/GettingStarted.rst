...
Getting the Mantid code and setting up Pre-commit
#######################
...
If not on windows, once the git clone has completed, and pre-commit is installed, navigate to the cloned repository in a terminal and add the pre-commit git hooks by executing:
